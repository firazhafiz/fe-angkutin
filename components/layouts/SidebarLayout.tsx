...
export default function SidebarLayout({ children }: SidebarLayoutProps) {
  ...
  return (
    <main className="w-full min-h-screen relative  bg-gray-100 overflow-hidden">
      <div className="flex gap-4 w-full mt-40 px-40 ">
        {/* Sidebar */}
        <div className="w-1/4 max-h-[720px] bg-white rounded-2xl p-5">
        ...
        {/* Main Content */}
        <div className="w-3/4 min-h-[720px] bg-white rounded-2xl p-5">{children}</div>
      </div>
    </main>
  );
}
